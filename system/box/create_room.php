...
<div class="pad_box">
	<div class="boom_form">
		<div class="setting_element">
			...
			<input id="set_room_name" class="full_input" type="text" maxlength="<?php echo $wali['max_room_name']; ?>" />
		</div>
		<div class="setting_element">	
		...
		<div class="setting_element">
			...
			<textarea id="set_room_description" class="full_textarea medium_textarea" type="text" maxlength="<?php echo $wali['max_description']; ?>"></textarea>
		</div>
	</div>
