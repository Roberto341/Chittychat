...
?>
	<div id="login_form_box" class="pad_box">
		<div class="boom_form">
			...
			<input id="user_username" class="user_username full_input" type="text" maxlength="50" name="uname">
			<p class="label tpad5"><?php echo $lang['password']; ?></p>
			<input id="user_password"  class="user_password full_input" maxlength="30" type="password" name="pass"><br />
		</div>
		<div class="login_control">
			<button onclick="sendLogin();" type="submit" class="theme_btn full_button large_button"><i class="fa fa-sign-in"></i> <?php echo $lang['login']; ?></button>
		</div>
