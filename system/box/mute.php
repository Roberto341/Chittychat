    ...
    <div class="modal_top_empty">
        <div class="btable">
            <div class="avatar_top_mod">
                <img src="<?php echo myAvatar($user['user_avatar']); ?>" />
            </div>
...
<div class="pad_box">
    <div class="setting_element">
        ...
        <select id="mute_delay">
            <?php echo optionMinutes($wali['default_mute'], array(2, 5, 10, 15, 30, 60, 1440, 2880, 4320, 5760, 7200, 8640, 10080, 20160, 43200)); ?>
        </select>
    </div>
    <div class="setting_element">
